let data = [{
			cat: 'Quantitative', name: 'Analyse Numrique pour Ingnieurs', value: 103,
			icon: 'img/epfl.svg',
			desc: `
			...
			cat: 'Quantitative', name: 'Asset Pricing', value: 392,
			icon: 'img/the-university-of-chicago-vector-logo.png',
			desc: `
			...
			cat: 'Quantitative', name: 'Automata', value: 493,
			icon: 'img/stanford-university.png',
			desc: `
			...
			cat: 'Interdisciplinary', name: 'Big Data in Education', value: 710,
			icon: 'img/columbia.png',
			desc: `
			...
			cat: 'Quantitative', name: 'Bioinformatics Algorithms (Part 1)', value: 941,
			icon: 'img/UC_sandiego.png',
			desc: `
			...
			cat: 'Education', name: 'Blended Learning: Personalizing Education for Students', value: 3022,
			icon: 'img/Silicon-Schools-Logo.png',
			desc: `
				Handy and resourceful JavaScript library to parse, validate, manipulate, and display dates and times.
			`
		}, {
			cat: 'Science', name: 'Synapses, Neurons and Brains', value: 2040,
			icon: 'img/huji.svg',
			desc: `
				A javascript library for formatting and manipulating numbers.
			`
		}, {
			cat: 'Science', name: 'Climate Literacy: Navigating Climate Change Conversations', value: 948,
			icon: 'img/ubc.png',
			desc: `
			...
			cat: 'Quantitative', name: 'Compilers', value: 355,
			icon: 'img/stanford-university.png',
			desc: `
			...
			cat: 'Quantitative', name: 'Computational Methods for Data Analysis', value: 269,
			icon: 'img/UWash.png',
			desc: `
